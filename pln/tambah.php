...
<head>
  ...
  <title>Tambah Data - SIDIA - Sistem Informasi Data Inventaris Ac PLN</title>
      ...
      <div class="col-md">
        <form action="simpan.php" method="post" class="justify-content">
          <div class="mb-3">
            ...
            <input type="text" class="form-control w-50" name="NAMA_RUANGAN" placeholder="Nama Ruangan">
          </div>
          <div class="mb-3">
            <label for="merk" class="form-label">Merk Ac</label>
            <input type="text" class="form-control w-50" name="MERK_AC" placeholder="Merk Ac">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control w-50" name="KONDISI" placeholder="Kondisi">
          </div>
          <div class="mb-3">
            <label for="keterangan" class="form-label">Keterangan/Usulan</label>
            <textarea class="form-control w-50" name="KETERANGAN" placeholder="Keterangan/Usulan"></textarea>
          </div>
          <div class="mb-3">
